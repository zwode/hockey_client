<template>
	<div class="">
		<MainNav/>
		<!--<MainBanner/>-->
		<MainAboutCompany class="container mt-3"/>
		<MainCollectiveCard class="bg-brand mt-5"/>
		<!--<MainSilider class="container"/>-->
		<MainTabs class="container"/>
		<MainGalleray class="bg-brand py-5 my-3"/>
		<div class="whatsapp-icon">
			<a href="https://api.whatsapp.com/send?phone=77019563020" class="pos-link">
